...
UNIX-like environment, arm-none-eabi toolchain in your $PATH, bash, python3, awk, xxd (sometimes in vim-common package)
Tested environment: macOS 13.2 (Intel) with arm-gnu-toolchain-12.2.rel1-darwin-x86_64-arm-none-eabi.pkg from https://developer.arm.com/downloads/-/arm-gnu-toolchain-downloads and Python 3.9.6 from Xcode 14.2
